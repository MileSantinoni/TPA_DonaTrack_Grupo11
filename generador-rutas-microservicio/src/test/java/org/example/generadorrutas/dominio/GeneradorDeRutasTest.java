package org.example.generadorrutas.dominio;
...
public class GeneradorDeRutasTest {

  private final GeneradorDeRutas generaRutas  = new GeneradorDeRutas();
  ...
  public void agrupaDonacionesDeLaMismaEntidadYLasAsignaACamionesDisponibles() {
    ...
    List<RutaGeneradaResponse> rutas = generaRutas.generar(request);
